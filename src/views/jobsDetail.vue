      ...
      <div class="row bg-white pb-3" style="border-bottom: 5px solid whitesmoke;">
        ...
        <div class="col-md-2 mt-3">
          <img v-if="detail.recruiterImage != null"
            :src="'https://toptalentapp.com:9091/resources/' + detail.recruiterImage" alt="..." width="100%">
        ...
        <div class="col-md-4 mt-5">
          <button class="btn btn-outline-primary jobicn" data-bs-toggle="modal"
            :data-bs-target="'#exampleModalToggle' + detail.jobId" role="button" v-on:click="getDetail(detail.jobId)">
                ...
                <div class="modal-body">
                  <form @submit.prevent="submitForm">
                    ...
                    <div class="mb-3">
                      ...
                      <ckeditor :editor="editor" tag-name="textarea" :model-value="jobRequirement"
                        v-model="detail.jobRequirement" :config="editorConfig"></ckeditor>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <ckeditor :editor="editor" tag-name="textarea" :model-value="jobDesc" v-model="detail.jobDesc"
...
export default {
    ...
    return {
      ...
      config: {
        contentFilter: {
          elements: {
            br: (element) => {
              delete element.attributes['data-cke-filler'];
              return element;
            }
          }
        }
  ...
  methods: {
    ...
    async updateJobData(id) {
      try {
        await axios.patch(
          `https://toptalentapp.com:9091/api/v1/job/${id}?jobName=${encodeURIComponent(this.detail.jobName)}&jobStatus=${this.detail.jobStatus}&jobSalary=${this.detail.jobSalary}&jobPosition=${encodeURIComponent(this.detail.jobPosition)}&jobAddress=${encodeURIComponent(this.detail.jobAddress)}&jobDesc=${encodeURIComponent(this.detail.jobDesc.replace(/&nbsp;/g, " "))}&jobRequirement=${encodeURIComponent(this.detail.jobRequirement.replace(/&nbsp;/g, " "))}`
        )
