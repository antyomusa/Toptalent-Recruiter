      ...
      <div class="main">
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-4 sticky-top"
          ...
          <div class="container-fluid">
            ...
            <form class="d-flex">
              <div>
                <button v-if="this.profile == '' || this.profile == null" type="button" class="btn btn-primary"
          ...
          <div class="modal-dialog">
            <div class="modal-content" style="border-radius:20px;">
              ...
              <div class="modal-footer justify-content-center">
                ...
                <button type="button" class="btn btn-outline-danger" style="width:139px;"
          ...
          <div class="modal fade" id="jobModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
              <div class="modal-content">
                ...
                <div class="modal-body" id="formPost">
                  <div class="form-data" v-if="!submitted">
                    ...
                    <div class="forms-inputs mb-4"> <span>Job salary:</span>
                      <input type="number" v-model="jobSalary"
                        ...
                        v-on:blur="jobsalaryBlured = true" min="1" step="1"
                        onkeypress="return event.keyCode === 8 || event.charCode >= 48 && event.charCode <= 57" maxlength="8" @keyup="limitInput">
                      <div class="invalid-feedback">Please fill blank form</div>
                    </div>
                  ...
                  <div class="success-data" id="askAgain" v-else>
                    <div class="text-center d-flex flex-column"> <i class='bx bxs-badge-check'></i> <span
                      ...
                      <div class="col text-center fs-3">
                        <button class="btn btn-primary valid-pop m-1" type="submit" v-on:click.prevent="addjob">Yes, post
                          it!</button>
                        <button class="btn btn-outline-danger valid-pop m-1" v-on:click="cancelPost"
...
export default {
  ...
  methods: {
    ...
    limitInput() {
      if (this.jobSalary.length > 8) {
        this.jobSalary = this.jobSalary.slice(0, 8);
      }
    },
    ...
    async addjob() {
      try {
        ...
        await axios.post(
          `https://toptalentapp.com:9091/api/v1/job/create?jobName=${encodeURIComponent(this.jobName)}&recruiterId=${recruiterId}&jobSalary=${encodeURIComponent(this.jobSalary)}&jobPosition=${encodeURIComponent(this.jobPosition)}&jobAddress=${encodeURIComponent(this.jobAddress)}&jobDesc=${encodeURIComponent(this.jobDesc)}&jobRequirement=${encodeURIComponent(this.jobRequirement)}`
        );
