        ...
        <div class="col-md-6">
          <div class="card">
            <div class="card-body">
              ...
              <p class="card-text">
                <font-awesome-icon icon="fa-solid fa-user" class="icn" /> {{ profile.recruiterStaff }}
              </p>
          ...
          <div class="card m-1 ctnt">
            <div class="card-body section-contact panel-2">
              ...
              <div>
                ...
                <a class="card-text" v-else :href="'https://mail.google.com/mail/' + profile.recruiterEmail"
                  target="_blank">
