<template>
  <div class="card">
    ...
    <div class="card-body dark" v-if="item.jobStatus != 'visible'">
      <img v-if="item.recruiterImage != null" :src="'https://toptalentapp.com:9091/resources/' + item.recruiterImage"
        class="card-img-top dark" style="filter: grayscale(100%)" alt="...">
      ...
      <button class="btn btn-success" data-bs-toggle="modal" :data-bs-target="'#exampleModalToggle' + item.jobId"
        role="button" v-on:click="getDetail(item.jobId)">Edit</button>
    </div>

    <div class="card-body" v-else>
      <img v-if="item.recruiterImage != null" :src="'https://toptalentapp.com:9091/resources/' + item.recruiterImage"
        class="card-img-top dark" alt="...">
      <img v-else src="https://toptalentapp.com:9091/resources/meta.png" class="card-img-top dark" alt="...">
      <h5 class="card-title">{{ item.jobName }}</h5>
